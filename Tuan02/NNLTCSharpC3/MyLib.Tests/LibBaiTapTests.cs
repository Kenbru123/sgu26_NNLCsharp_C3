...
public class LibBaiTapTest
{
    [Fact]
    public void GiaiPTBac2_A0_B0_C0_VoSoNghiem()
    {
        double x1 = 0, x2 = 0;
        int result = Class1.GiaiPTBac2(0, 0, 0, ref x1, ref x2);
    ...
    {
        double x1 = 0, x2 = 0;
        int result = Class1.GiaiPTBac2(0, 0, 5, ref x1, ref x2);
    ...
    {
        double x1 = 0, x2 = 0;
        int result = Class1.GiaiPTBac2(0, 2, -4, ref x1, ref x2);
        Assert.Equal(1, result);
        Assert.Equal(2,x1);
    }
    ...
    {
        double x1 = 0, x2 = 0;
        int result = Class1.GiaiPTBac2(1, 0, 1, ref x1, ref x2);
        Assert.Equal(0, result);
    }
    ...
    {
        double x1 = 0, x2 = 0;
        int result = Class1.GiaiPTBac2(1, -2, 1, ref x1, ref x2);
        Assert.Equal(1, result);
        Assert.Equal(1, x1);
    }
    ...
    {
        double x1 = 0, x2 = 0;
        int result = Class1.GiaiPTBac2(1, -3, 2, ref x1, ref x2);
